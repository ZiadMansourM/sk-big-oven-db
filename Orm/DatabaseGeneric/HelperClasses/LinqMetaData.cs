...
namespace Orm.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((Orm.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting RecipesCategoryEntity instances in the database.</summary>
		public DataSource2<RecipesCategoryEntity> RecipesCategory {	get { return new DataSource2<RecipesCategoryEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
