...
namespace Orm.EntityClasses
{
	...
	
	{
		...
		protected class UserEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserEntity", InheritanceHierarchyType.None, false, (int)Orm.EntityType.UserEntity, typeof(UserEntity), typeof(UserEntityFactory), false);
			}
		}
		...
		/// <remarks>Mapped on  table field: "users"."refresh_token".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "users"."token_created".<br/>Table field type characteristics (type, precision, scale, length): Timestamp, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "users"."token_expires".<br/>Table field type characteristics (type, precision, scale, length): Timestamp, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "users"."username".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
